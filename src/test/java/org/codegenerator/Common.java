...
public class Common {
    ...
    public static <R> R createObject(String generatedClassName, String ... nestedClasses) {
        return GENERATED_CODE_COMPILER.createObject(generatedClassName, nestedClasses);
    }
}
