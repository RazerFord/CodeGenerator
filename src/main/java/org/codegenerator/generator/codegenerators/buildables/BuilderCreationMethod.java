...
public class BuilderCreationMethod implements Buildable {
    private final Class<?> clazz;
    private final String variableName;
    private final Executable executable;

    public BuilderCreationMethod(Class<?> clazz, String variableName, Executable executable) {
        this.clazz = clazz;
    ...
    public void build(@NotNull Converter converter,
        ...
        if (executable instanceof Constructor<?>) {
            codeBlock = CodeBlock.builder()
                    .addStatement("$T $L = new $T()", clazz, variableName, clazz)
                    .build();
        }
        if (executable instanceof Method) {
            ...
            codeBlock = CodeBlock.builder()
                    .addStatement("$T $L = $T.$L()", clazz, variableName, declaringClass, method.getName())
                    .build();
        }
